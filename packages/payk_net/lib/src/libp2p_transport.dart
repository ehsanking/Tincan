...
/// A [Transport] backed by a libp2p [Host]: it maps Payk's frame-based
...
/// at-least-once retry policy in payk_core's `OutboundQueue`.
///
...
class Libp2pTransport implements Transport {
  ...
  /// The single application protocol id all Payk frames are sent over.
  static const String protocolId = '/payk/msg/1.0.0';
